...
expect(appJs.includes('pastelSaturation') && appJs.includes('color.s - 25'), '找不到淺色卡片配色設定');
...
expect(serviceWorker.includes("CACHE_NAME = 'fx-terminal-pwa-v12'"), 'Service Worker 快取版本未更新');
